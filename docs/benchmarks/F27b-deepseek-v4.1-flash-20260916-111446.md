# Replay F27b with opencode/deepseek-v4.1-flash (high): PASS
...
cost $0.8637, 78 turns, 20 min, thinking high, role worker

expected: {'popup': ('5094', '1148', '80')}

```
verify_rows: wt/replay-F27b-20260916-111446 (73a2ba5) in /tmp/bnwt/verify-73a2ba5
  popup          FAILED   5094/1148/80/5286        MATCH (isolated line)
verify_rows: PASS
```

session: /tmp/bn-pi/replay/20260916-111446
