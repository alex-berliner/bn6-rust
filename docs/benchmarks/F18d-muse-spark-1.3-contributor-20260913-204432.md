# Replay F18d with openrouter/meta/muse-spark-1.3-contributor (high): PASS
...
cost $0.0478, 83 turns, 14 min, thinking high, role worker

expected: {'windowclose': ('648948', '27391', '40')}

```
verify_rows: wt/replay-F18d-20260913-204432 (5467058) in /tmp/bnwt/verify-5467058
  windowclose    FAILED   648948/27391/40/732198   MATCH
verify_rows: PASS
```

session: /tmp/bn-pi/replay/20260913-204432
