# Replay F25c with hyper/minimax-m3 (high): PASS
...
cost $0.7297, 276 turns, 6 min, thinking high, role worker

expected: {'mettaur': ('4265', '800', '70')}

```
verify_rows: wt/replay-F25c-20260914-125223 (4a57514) in /tmp/bnwt/verify-4a57514
  mettaur        FAILED   4265/800/70/45788        MATCH
verify_rows: PASS
```

session: /tmp/bn-pi/replay/20260914-125223
