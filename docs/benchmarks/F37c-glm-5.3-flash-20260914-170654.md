...
cost $0.8288, 232 turns, 34 min, thinking high, role worker

expected: {'cursor': ('34902', '232', '170'), 'windowclose': ('12538', '1200', '40')}

```
verify_rows: wt/replay-F37c-20260914-170654 (fe86e84) in /tmp/bnwt/verify-fe86e84
  cursor         FAILED   53/52/170/186276         MISMATCH total,worst (claimed 34902/232/170/-)
  windowclose    FAILED   25/25/40/207166          MISMATCH total,worst (claimed 12538/1200/40/-)
verify_rows: FAIL
```

session: /tmp/bn-pi/replay/20260914-170654

balance 37.4 -> 19.3 but 1 other pi sessions were spending: credits not attributable
