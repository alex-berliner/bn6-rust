...
cost $0.2783, 198 turns, 16 min, thinking high, role worker

expected: {'popup': ('5094', '1148', '80')}

```
verify_rows: wt/replay-F27b-20260914-160645 (f1acb3f) in /tmp/bnwt/verify-f1acb3f
  popup          FAILED   5094/1148/80/5286        MATCH
verify_rows: PASS
```

session: /tmp/bn-pi/replay/20260914-160645

balance 55.0 -> 43.3 but 2 other pi sessions were spending: credits not attributable
