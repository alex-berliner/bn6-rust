# Replay F18d with hyper/kimi-k2.5 (high): PASS
...
cost $0.6819, 76 turns, 16 min, thinking high, role worker

expected: {'windowclose': ('648948', '27391', '40')}

```
verify_rows: wt/replay-F18d-20260914-112944 (7f2fabc) in /tmp/bnwt/verify-7f2fabc
  windowclose    FAILED   648948/27391/40/732198   MATCH
verify_rows: PASS
```

session: /tmp/bn-pi/replay/20260914-112944
