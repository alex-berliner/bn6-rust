...
cost $0.1839, 78 turns, 24 min, thinking high, role worker

expected: {'windowclose': ('648948', '27391', '40')}

```
verify_rows: wt/replay-F18d-20260916-103507 (ffefe11) in /tmp/bnwt/verify-ffefe11
  windowclose    FAILED   648948/27391/40/732198   MATCH (isolated line)
verify_rows: PASS
```

session: /tmp/bn-pi/replay/20260916-103507

balance 248.5 -> 241.3 but 2 other pi sessions were spending: credits not attributable
