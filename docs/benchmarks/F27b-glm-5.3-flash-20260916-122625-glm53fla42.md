...
cost $0.2169, 88 turns, 18 min, thinking high, role worker

expected: {'popup': ('5094', '1148', '80')}

```
verify_rows: wt/replay-F27b-20260916-122625-glm53fla42 (e8a70e6) in /tmp/bnwt/verify-e8a70e6
  popup          FAILED   5094/1148/80/5286        MATCH (isolated line)
verify_rows: PASS
```

session: /tmp/bn-pi/replay/20260916-122625-glm53fla42

balance 215.4 -> 206.0 but 1 other pi sessions were spending: credits not attributable
