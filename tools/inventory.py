...
SECTION_NOTES = {
    ...
    "panels (M3)":
        lambda meta: (
            ...
            " (object.s:2601) is a trampoline to _object_setPanelType, so 36 bl"
            " sites (asm31 x28, asm32 x2, asm00_2 x2, asm38 x4) + 13 direct strb"
