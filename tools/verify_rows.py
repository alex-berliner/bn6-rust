...
DRIFT_ENVELOPE = {
    # provenance: peeked -- max spread of field integrated totals recorded across input
    # versions: 158928 (coordinator, main), 158935 (F45 landed @1c49bc5, ROM ab80121e...),
    # 158953 (F46's session AND F48's re-run on those same bytes), 158930 (F48 x4 on
    # ed9c9c1's ROM 1997be3b..., the T17/T19 chip work -- a real tree-side -23, one frame).
    # Max recorded spread 158953 - 158928 = 25. Rows with search=None (field-bg1/2/3) are
    # excluded by the searched-row guard in main(), not by this table.
    "field": 25,
}
