    ...
    Check(
        ...
        align=Align(
            ...
            note="AUDIT ticket step 5: 'cursor... just broke on a hardcoded lag... marker "
                 ...
                 "occlusion, measured: the OBJ diff falls in three x bands -- 2..77, 83..117 "
                 "and 122..189 -- and only the third is outside the chip window (BG3 covers "
                 "x<112), its px-frame count being 272340 exactly. THE FOUR UNCHECKED "
