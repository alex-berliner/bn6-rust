    ...
    Check(
        ...
        align=Align(
            ...
            note="T216: THE METTAUR ROW'S OWN WINDOW AND BAND, with the cross-alliance "
                 ...
                 "render-gate arm -- blindVisualHandledHere_8016934 (asm00_2.s:16918-16942, "
                 "routine 16893-16961) "
                 ...
                 "through object_getFlag (T18's cited reader, asm00_2.s:21739-21744, "
...
PORTED_CHECKS: List[Check] = [
    ...
    Check(
        ...
        # (eStruct+0xe, the beast-out counter, sub_801CB38 stores it at
        # asm00_2.s:27442/:27478/:27485 (T230 cite-fix; the inherited
        # :27343-27344 was an unrelated strh loop); T123 measured it 0x03 on this
