...
### T9f. Does `eS20364C0.JumpOffset00 = 8` start the poked battle: one-shot poke test, and the first attack event's frame  *(OPEN -- 2026-09-14, follows T9d, advances M5)*
