...
### F12. The chip rows' own residues, family by family -- multi-pass, stays OPEN until every chip row is 0  *(OPEN -- 2026-09-14, areagrab remainder landed ad653c0: chip-areagrab 1278/684/77->0/0/77 [neg 28276 not blind])*
