...
### F10. `buster` isolated: 3172 px over 32 frames  *(PARTIAL -- 2026-09-13; first attempt blocked with diagnosis, follow-up F10b written, branch wt/f10-buster kept unmerged)*
...
### F10b. `buster`: fire in the 0x08 window with the miss-pose fix, or close the row  *(OPEN -- 2026-09-13)*
