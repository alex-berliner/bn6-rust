...
### F41. chip-use integrated: the last 2 px, then delete the chip-use allowlist entry  *(NEGATIVE -- 2026-09-15, CLOSES as NEGATIVE, branch wt/f41-chip-use-2px @ 233adfe kept UNMERGED [its tools/allowlist.py re-title refute)*
