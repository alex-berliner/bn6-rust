...
### F12. The chip rows' own residues, family by family -- multi-pass, stays OPEN until every chip row is 0  *(OPEN -- 2026-09-14, family-0x15 localized, no landing [budget stop, no edits]: areagrab 43367 [popup strip + missing steal orbs], )*
