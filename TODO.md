...
### T141. The cursor seam class on wt/t138's binary: does ANY pad value put its tear back in class, or is the pad exhausted?  *(PARTIAL -- 2026-09-17, THE SIX-STAMP QUESTION IS ANSWERED WITH NUMBERS: the pad is NOT exhausted)*
...
### T142. M8's band, decided not described: is the black top of the reveal capture a mid-scan CNT store or a map copy that arrives late?  *(OPEN -- 2026-09-18)*
