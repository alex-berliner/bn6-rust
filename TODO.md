...
### F12. The chip rows' own residues, family by family -- multi-pass, stays OPEN until every chip row is 0  *(OPEN -- 2026-09-13, suprvulc: still 2464/177/113, no fix [budget stop, no edits])*
