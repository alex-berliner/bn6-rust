...
### F12. The chip rows' own residues, family by family -- multi-pass, stays OPEN until every chip row is 0  *(OPEN -- 2026-09-13, bugbomb family: chip-bugbomb 8280/414->0/0/70 PASS [neg 23486])*
