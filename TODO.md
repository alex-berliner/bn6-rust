...
### T97. M10 — Netbattle recon: handshake + chip-trade routines + UI state field + two-instance scenario design  *(NEGATIVE -- 2026-09-17, Landed d3f65fc [docs-only]: docs/coverage/netbattle.md, 16 cites - handshake libSIO814469C [libs.s:799-807, SI)*
