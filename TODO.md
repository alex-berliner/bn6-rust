...
### F12. The chip rows' own residues, family by family -- multi-pass, stays OPEN until every chip row is 0  *(OPEN -- 2026-09-13, vdoll family: chip-vdoll 628/564->0/0/70 PASS [neg 36375])*
