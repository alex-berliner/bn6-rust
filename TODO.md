...
### F12. The chip rows' own residues, family by family -- multi-pass, stays OPEN until every chip row is 0 *(OPEN -- 2026-09-13, feet per-family push order: poisseed 115/43->0/0/70 PASS [neg 50708], ice/grass/minibomb 0)*
