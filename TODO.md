...
### T105. M7 emotion window: pick one reachable emotion state (Full Synchro via Counter Hit, or any pre-battle-set state) and port its face-selection gate  *(OPEN -- 2026-09-17, Poke mechanism discovered: --poke at 0x0203528F:0x01 does NOT set the byte [poke rounds to half-word 0x0203528)*
