...
### T9c. The Gunner: implement what T9b measured (the frame-60 lever, enemy_kind, the routine, the art, the row)  *(PARTIAL -- 2026-09-14, LANDED as 1f7efc9 [partial, no gunner row])*
...
### T10. Inventory of the battle engine from the ROM's own tables: the completion checklist gets its counts  *(OPEN -- 2026-09-14)*
