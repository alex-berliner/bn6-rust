...
### F12. The chip rows' own residues, family by family -- multi-pass, stays OPEN until every chip row is 0  *(OPEN -- 2026-09-14, verifier on next4 claims: popup-arms ungated CONFIRMED [battle.rs:3594/3603, same FLAG_HUD_LIVE pattern ready])*
