...
const SEAM_PHASE_PAD_ITERS: u32 = 20; // provenance: fitted -- T111 size sweep on the cursor row: k=37 seam 28px at 0 iters, 25@1, 15@8, 6@16, 0@17, 17@18, 25@20 (V-bottom at 17); k=97 tear 1px throughout. T230 sweep on the MERGED tree (T216 BLIND-gate layout + T225 blink port), cursor row: 19:766/728, 20:1/1, 21:1/1, 22:1/1, 23:16241/3385, 24:6/6, 25:1/1 -- all of 20/21/22 (and 25) read the exact main line 1/1/170/186279/neg 186279. T231 sweep (boot-frame reclaim, post-T216 main a06d14e), windowclose added to the sweep: 20: PASS 0/0/40 neg 207166 (the T220 line), 21: FAIL 63962/3557/40 neg 266037 (main's drift), 22: PASS 0/0/40 neg 207166, 25: FAIL 63962/3557/40 neg 266037 (T230) -- the boot-capture marker phase at pad 21 crosses the vblank boundary one frame off, desyncing windowclose's script-timed Start@230/A@260 presses from battle time (T220's butterfly), while cursor's seam plateau still spans 20/21/22. 20 pinned: inside cursor's plateau AND windowclose's zero, full acceptance set (windowclose/cursor/emotion_skip/blind_met/mettaur) measured at exactly this value
