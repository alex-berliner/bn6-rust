...
![Mettaur row: canon on top, ours before and after F25d](../captures/mettaur-f25d-progress.gif)
...
![Popup row across F28b](../captures/popup-f28b-progress.gif)
...
![Buster row: the vacuous row (middle) and the re-cut row at 0 (bottom)](../captures/buster-f31b-progress.gif)
...
![Results screen across F34](../captures/result-f34-progress.gif)
