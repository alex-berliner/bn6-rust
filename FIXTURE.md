...
- bit 6 `FLAG_HUD_LIVE`: the fixture's canon capture sits before the battle-HUD teardown (canon mask dword_20352C0 bit 14 set), so a zero-enemy arena keeps the emotion window up; F27b, provenance peeked.
